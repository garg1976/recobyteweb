...
function owlcarousel() {
  $('.owl-carousel').each(function () {
    ...
    $carousel.owlCarousel({
      items: $carousel.data("items") || 3, // Default = 3 items
      ...
      responsive: {
        0: { items: $carousel.data('xs-items') || 1 },
        576: { items: $carousel.data('sm-items') || 2 },
        768: { items: $carousel.data('md-items') || 3 },
        1024: { items: $carousel.data('lg-items') || 4 },
        1200: { items: $carousel.data('items') || 3 }
      },
    });
  });
}
